...
int main()
{
	...
	//step 1 : 비트맵 파일 열기
    fpBmp = fopen("test_picture.bmp", "rb");    // 비트맵 파일을 바이너리 모드로 열기
    ...
    // step 7 : 파일에서 픽셀 데이터 크기만큼 읽음. 읽기에 실패하면 파일 포인터를 닫고 프로그램 종료
